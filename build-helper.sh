...
# transform_to_archive_filename lives in common-lhelper.sh (now backed by
# archive_filename.lua). Kept here as a marker for the former site of the
# bash char-loop; the caller at the bottom of enter_archive is unchanged.
